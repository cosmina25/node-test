System.register(['angular2/core', 'angular2/http', 'rxjs/Rx', '../common/utilities'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            PosterService = (function () {
                function PosterService(_http, _observable) {
                    this._http = _http;
                    this._observable = _observable;
                    this._uri = 'api/poster';
                }
                PosterService.prototype.create = function (author) {
                    return this._http.post(this._uri, JSON.stringify(author))
                        .map(this._observable.json)
                        .catch(this._observable.error);
                };
                PosterService.prototype.retrieve = function (id) {
                    if (id === void 0) { id = ''; }
                    return this._http.get(this._uri + "/" + id)
                        .map(this._observable.json)
                        .catch(this._observable.error);
                };
                PosterService.prototype.update = function (author) {
                    return this._http.put(this._uri + "/" + author._id, JSON.stringify(author))
                        .map(this._observable.json)
                        .catch(this._observable.error);
                };
                PosterService.prototype.delete = function (id) {
            ...
            exports_1("PosterService", PosterService);
        }
    }
});
