    ...
    return {
        ...
        execute: function() {
            BadgeService = (function () {
                function BadgeService(_http, _observable, _options) {
                    this._http = _http;
                    this._observable = _observable;
                    this._options = _options;
                    this._uri = 'api/badge';
                }
                BadgeService.prototype.create = function (badge) {
                    //noinspection TypeScriptUnresolvedFunction
                    return this._http.post(this._uri, JSON.stringify(badge))
                        .map(this._observable.json)
                        .catch(this._observable.error);
                };
                BadgeService.prototype.retrieve = function (id) {
                    //noinspection TypeScriptUnresolvedFunction
                    return this._http.get(this._uri + "/" + id)
                        .map(this._observable.json)
                        .catch(this._observable.error);
                };
                BadgeService.prototype.update = function (badge) {
